...
function printFooter(collective) {
  ...
  emptyLine();
  print()("".concat(chalk.bold("".concat(emoji('👉 '), " ").concat(collective.donationText)), " ").concat(chalk.underline(collective.donationUrl)));
  emptyLine();
}
...
var fetchPkg = function fetchPkg(pathToPkg) {
  var fullPathToPkg = path.resolve("".concat(pathToPkg, "/package.json"));
