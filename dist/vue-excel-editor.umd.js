(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vuedraggable'), require('xlsx'), require('moment')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vuedraggable', 'xlsx', 'moment'], factory) :
  (global = global || self, factory(global.VueExcelComponent = {}, global.vuedraggable, global.XLSX, global.moment));
}(this, (function (exports, draggable, XLSX, moment) { 'use strict';
      ...
      vsbMouseMove(e) {
        if (e.buttons === 0) {
          ...
          if (this.noPaging) {
            ...
            this.vScroller.runner = recPos + '<br>' + this.fields.filter((field, i) => field.keyField || field.sticky || this.sortPos === i).map(field => rec[field.name]).join('<br>');
            this.$forceUpdate();
          }
        }
      },
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.vScroller.runner,
                          expression: "vScroller.runner"
                        }
                      ],
                      staticClass: "runner",
                      domProps: { innerHTML: _vm._s(_vm.vScroller.runner) }
                    })
                  ]
                )
              ]
